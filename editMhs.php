...
<body bgcolor="pink">
	...
	<form action="edit-prosesMhs.php" method="post">
		<input type="hidden" name="id" value="<?php echo $id; ?>">	<!-- membuat inputan hidden dan nilainya adalah siswa_id -->
		<table cellpadding="3" cellspacing="0">
			<tr>
				<td>NIM</td>
				<td>:</td>
				<td><input type="text" name="NIM" size="50" value="<?php echo $data['NIM']; ?>" required></td>	<!-- value diambil dari hasil query -->
			</tr>
			<tr>
				<td>Nama</td>
				<td>:</td>
			...
			<tr>
				<td>Tanggal Lahir</td>
				<td>:</td>
				<td><input type="text" name="Tgl_lahir" size="50" value="<?php echo $data['Tgl_lahir']; ?>" required></td>
			</tr>
			<tr>
				<td>Alamat</td>
				<td>:</td>
            ...
            <tr>
				<td>Password</td>
				<td>:</td>
				<td><input type="Password" name="Password" size="50" value="<?php echo $data['Password']; ?>" required></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td></td>
